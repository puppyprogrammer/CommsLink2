...
const skeleton = [
  ...
  { id: 'l_shoulder', position: [-0.17, 0.10, 0],   parent_id: 'chest' },
  { id: 'r_shoulder', position: [0.17, 0.10, 0],    parent_id: 'chest' },
  { id: 'l_elbow',    position: [0, -0.20, 0],      parent_id: 'l_shoulder' },
  { id: 'r_elbow',    position: [0, -0.20, 0],      parent_id: 'r_shoulder' },
  { id: 'l_hand',     position: [0, -0.20, 0],      parent_id: 'l_elbow' },
  { id: 'r_hand',     position: [0, -0.20, 0],      parent_id: 'r_elbow' },
  { id: 'l_hip',      position: [-0.08, 0, 0],      parent_id: 'root' },
  { id: 'r_hip',      position: [0.08, 0, 0],       parent_id: 'root' },
