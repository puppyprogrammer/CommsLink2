...
const HUMANOID_SKELETON: JointDef[] = [
  ...
  { id: 'spine', position: [0, 0.3, 0], parent_id: 'root' },
  { id: 'chest', position: [0, 0.25, 0], parent_id: 'spine' },
  { id: 'neck', position: [0, 0.15, 0], parent_id: 'chest' },
  { id: 'head', position: [0, 0.15, 0], parent_id: 'neck' },
  { id: 'l_shoulder', position: [-0.18, 0, 0], parent_id: 'chest' },
  { id: 'l_elbow', position: [-0.22, 0, 0], parent_id: 'l_shoulder' },
  { id: 'l_hand', position: [-0.2, 0, 0], parent_id: 'l_elbow' },
  { id: 'r_shoulder', position: [0.18, 0, 0], parent_id: 'chest' },
  { id: 'r_elbow', position: [0.22, 0, 0], parent_id: 'r_shoulder' },
  { id: 'r_hand', position: [0.2, 0, 0], parent_id: 'r_elbow' },
  { id: 'l_hip', position: [-0.1, 0, 0], parent_id: 'root' },
  { id: 'l_knee', position: [0, -0.35, 0], parent_id: 'l_hip' },
  { id: 'l_foot', position: [0, -0.35, 0], parent_id: 'l_knee' },
  { id: 'r_hip', position: [0.1, 0, 0], parent_id: 'root' },
  { id: 'r_knee', position: [0, -0.35, 0], parent_id: 'r_hip' },
  { id: 'r_foot', position: [0, -0.35, 0], parent_id: 'r_knee' },
];
